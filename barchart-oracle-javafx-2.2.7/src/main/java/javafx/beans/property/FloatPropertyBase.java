...
/*     */   {
/* 149 */     this.valid = true;
/* 150 */     return this.observable == null ? this.value : this.observable.floatValue();
/*     */   }
/*     */ 
...
/*     */     }
/* 161 */     if (this.value != paramFloat) {
/* 162 */       this.value = paramFloat;
/* 163 */       markInvalid();
/*     */     }
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 184 */     FloatBinding local1 = (paramObservableValue instanceof ObservableNumberValue) ? (ObservableNumberValue)paramObservableValue : new FloatBinding()
/*     */     {
/*     */       protected float computeValue()
/*     */       {
/* 192 */         return ((Number)paramObservableValue.getValue()).floatValue();
/*     */       }
/*     */     };
...
/* 213 */       this.value = this.observable.floatValue();
...
/* 227 */     StringBuilder localStringBuilder = new StringBuilder("FloatProperty [");
...
/* 251 */       FloatPropertyBase.this.markInvalid();
/*     */     }
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     javafx.beans.property.FloatPropertyBase
