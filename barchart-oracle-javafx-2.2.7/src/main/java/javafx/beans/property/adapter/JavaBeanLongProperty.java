...
/*     */ 
/*     */ public final class JavaBeanLongProperty extends LongProperty
...
/*     */ 
/*     */   JavaBeanLongProperty(PropertyDescriptor paramPropertyDescriptor, Object paramObject) {
...
/*     */   public long get()
/*     */   {
/* 118 */     return ((Long)AccessController.doPrivileged(new PrivilegedAction() {
/*     */       public Long run() {
/*     */         try {
/* 121 */           return Long.valueOf(((Number)MethodUtil.invoke(JavaBeanLongProperty.this.descriptor.getGetter(), JavaBeanLongProperty.this.getBean(), (Object[])null)).longValue());
/*     */         }
...
/*     */   }
/*     */ 
/*     */   public void set(final long paramLong)
/*     */   {
/* 141 */     if (isBound()) {
...
/*     */       public Void run() {
/*     */         try {
/* 147 */           MethodUtil.invoke(JavaBeanLongProperty.this.descriptor.getSetter(), JavaBeanLongProperty.this.getBean(), new Object[] { Long.valueOf(paramLong) });
/* 148 */           ExpressionHelper.fireValueChangedEvent(JavaBeanLongProperty.this.helper);
/*     */         } catch (IllegalAccessException localIllegalAccessException) {
...
/* 169 */       unbind();
/* 170 */       set(((Number)paramObservableValue.getValue()).longValue());
...
/* 268 */     StringBuilder localStringBuilder = new StringBuilder("LongProperty [");
 ...
 * Qualified Name:     javafx.beans.property.adapter.JavaBeanLongProperty
