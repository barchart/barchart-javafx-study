...
/*     */ 
/*     */ public final class JavaBeanIntegerProperty extends IntegerProperty
...
/*     */ 
/*     */   JavaBeanIntegerProperty(PropertyDescriptor paramPropertyDescriptor, Object paramObject) {
...
/*     */   public int get()
/*     */   {
/* 118 */     return ((Integer)AccessController.doPrivileged(new PrivilegedAction() {
/*     */       public Integer run() {
/*     */         try {
/* 121 */           return Integer.valueOf(((Number)MethodUtil.invoke(JavaBeanIntegerProperty.this.descriptor.getGetter(), JavaBeanIntegerProperty.this.getBean(), (Object[])null)).intValue());
/*     */         }
...
/*     */   }
/*     */ 
/*     */   public void set(final int paramInt)
/*     */   {
/* 141 */     if (isBound()) {
...
/*     */       public Void run() {
/*     */         try {
/* 147 */           MethodUtil.invoke(JavaBeanIntegerProperty.this.descriptor.getSetter(), JavaBeanIntegerProperty.this.getBean(), new Object[] { Integer.valueOf(paramInt) });
/* 148 */           ExpressionHelper.fireValueChangedEvent(JavaBeanIntegerProperty.this.helper);
/*     */         } catch (IllegalAccessException localIllegalAccessException) {
...
/* 169 */       unbind();
/* 170 */       set(((Number)paramObservableValue.getValue()).intValue());
...
/* 268 */     StringBuilder localStringBuilder = new StringBuilder("IntegerProperty [");
 ...
 * Qualified Name:     javafx.beans.property.adapter.JavaBeanIntegerProperty
