...
/*     */   {
/* 149 */     this.valid = true;
/* 150 */     return this.observable == null ? this.value : this.observable.doubleValue();
/*     */   }
/*     */ 
...
/*     */     }
/* 161 */     if (this.value != paramDouble) {
/* 162 */       this.value = paramDouble;
/* 163 */       markInvalid();
/*     */     }
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 184 */     DoubleBinding local1 = (paramObservableValue instanceof ObservableNumberValue) ? (ObservableNumberValue)paramObservableValue : new DoubleBinding()
/*     */     {
/*     */       protected double computeValue()
/*     */       {
/* 192 */         return ((Number)paramObservableValue.getValue()).doubleValue();
/*     */       }
/*     */     };
...
/* 213 */       this.value = this.observable.doubleValue();
...
/* 227 */     StringBuilder localStringBuilder = new StringBuilder("DoubleProperty [");
...
/* 251 */       DoublePropertyBase.this.markInvalid();
/*     */     }
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     javafx.beans.property.DoublePropertyBase
