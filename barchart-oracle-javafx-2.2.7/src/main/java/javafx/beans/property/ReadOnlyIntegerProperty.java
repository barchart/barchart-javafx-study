...
/*  80 */       return false;
/*     */     }
/*  82 */     if ((paramObject instanceof ReadOnlyIntegerProperty)) {
/*  83 */       ReadOnlyIntegerProperty localReadOnlyIntegerProperty = (ReadOnlyIntegerProperty)paramObject;
/*  84 */       Object localObject2 = localReadOnlyIntegerProperty.getBean();
/*  85 */       String str2 = localReadOnlyIntegerProperty.getName();
...
/* 118 */     StringBuilder localStringBuilder = new StringBuilder("ReadOnlyIntegerProperty [");
/*     */ 
 ...
 * Qualified Name:     javafx.beans.property.ReadOnlyIntegerProperty
