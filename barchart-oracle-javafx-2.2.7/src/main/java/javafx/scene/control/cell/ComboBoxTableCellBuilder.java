...
/*    */   {
/* 15 */     return new ComboBoxTableCellBuilder();
/*    */   }
/*    */ 
/*    */   public void applyTo(ComboBoxTableCell<S, T> paramComboBoxTableCell)
/*    */   {
/* 20 */     super.applyTo(paramComboBoxTableCell);
/* 21 */     int i = this.__set;
/* 22 */     if ((i & 0x1) != 0) paramComboBoxTableCell.setComboBoxEditable(this.comboBoxEditable);
/* 23 */     if ((i & 0x2) != 0) paramComboBoxTableCell.setConverter(this.converter);
/* 24 */     if ((i & 0x4) != 0) paramComboBoxTableCell.getItems().addAll(this.items);
/*    */   }
/*    */ 
...
/*    */   {
/* 71 */     ComboBoxTableCell localComboBoxTableCell = new ComboBoxTableCell();
/* 72 */     applyTo(localComboBoxTableCell);
/* 73 */     return localComboBoxTableCell;
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     javafx.scene.control.cell.ComboBoxTableCellBuilder
