...
/*     */   {
/* 118 */     return new StringBuilder().append("Edge[").append(this.curve).append(", ").append(this.ctag == 0 ? "L" : "R").append(", ").append(this.etag == -1 ? "O" : this.etag == 1 ? "I" : "N").append("]").toString();
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.javafx.geom.Edge
