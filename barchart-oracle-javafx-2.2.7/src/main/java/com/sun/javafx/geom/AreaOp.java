...
/* 181 */   private static Comparator YXTopComparator = new Object() {
...
/* 181 */   };
/*     */ 
/* 437 */   private static final CurveLink[] EmptyLinkList = new CurveLink[2];
/* 438 */   private static final ChainEnd[] EmptyChainList = new ChainEnd[2];
/*     */ 
...
/*     */             }
/*     */ 
/* 349 */             m++; } while ((m < k) && ((localObject1 = arrayOfEdge[m]).getEquivalence() == i5));
/* 350 */           m--;
/* 351 */           if (getState() == i6)
/* 352 */             i4 = 0;
/*     */           else
 ...
 * Qualified Name:     com.sun.javafx.geom.AreaOp
