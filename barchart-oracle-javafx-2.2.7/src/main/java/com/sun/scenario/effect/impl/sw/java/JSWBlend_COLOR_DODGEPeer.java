...
/*     */ {
/*     */   public JSWBlend_COLOR_DODGEPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/* 273 */         float f4 = f31;
/*     */ 
/* 277 */         if (f4 < 0.0F) f4 = 0.0F; else if (f4 > 1.0F) f4 = 1.0F;
/* 278 */         if (f1 < 0.0F) f1 = 0.0F; else if (f1 > f4) f1 = f4;
/* 279 */         if (f2 < 0.0F) f2 = 0.0F; else if (f2 > f4) f2 = f4;
/* 280 */         if (f3 < 0.0F) f3 = 0.0F; else if (f3 > f4) f3 = f4;
/* 281 */         arrayOfInt3[(i9 + i11)] = ((int)(f1 * 255.0F) << 16 | (int)(f2 * 255.0F) << 8 | (int)(f3 * 255.0F) << 0 | (int)(f4 * 255.0F) << 24);
/*     */ 
/* 287 */         f13 += f6;
/* 288 */         f14 += f8;
/*     */       }
...
/*     */     }
/*     */ 
/* 297 */     paramArrayOfImageData[1].releaseTransformedImage(localHeapImage1);
/* 298 */     paramArrayOfImageData[0].releaseTransformedImage(localHeapImage2);
/*     */ 
/* 301 */     return new ImageData(getFilterContext(), localHeapImage3, localRectangle1);
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.scenario.effect.impl.sw.java.JSWBlend_COLOR_DODGEPeer
