...
/*     */ {
/*     */   public JSWBlend_DIFFERENCEPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/*     */ 
/* 219 */         float f47 = f39 * f32;
/* 220 */         float f48 = f39 * f33;
/* 221 */         float f49 = f39 * f34;
/* 222 */         float f50 = f35 * f36;
/* 223 */         float f51 = f35 * f37;
/* 224 */         float f52 = f35 * f38;
/* 225 */         float f44 = f47 < f50 ? f47 : f50;
/* 226 */         float f45 = f48 < f51 ? f48 : f51;
/* 227 */         float f46 = f49 < f52 ? f49 : f52;
/*     */ 
/* 230 */         float f40 = f32 + f36 - 2.0F * f44;
/* 231 */         float f41 = f33 + f37 - 2.0F * f45;
/* 232 */         float f42 = f34 + f38 - 2.0F * f46;
/* 233 */         float f28 = f40;
/* 234 */         float f29 = f41;
/* 235 */         float f30 = f42;
/* 236 */         float f31 = f43;
...
/* 243 */         float f4 = f31;
/*     */ 
/* 247 */         if (f4 < 0.0F) f4 = 0.0F; else if (f4 > 1.0F) f4 = 1.0F;
/* 248 */         if (f1 < 0.0F) f1 = 0.0F; else if (f1 > f4) f1 = f4;
/* 249 */         if (f2 < 0.0F) f2 = 0.0F; else if (f2 > f4) f2 = f4;
/* 250 */         if (f3 < 0.0F) f3 = 0.0F; else if (f3 > f4) f3 = f4;
/* 251 */         arrayOfInt3[(i9 + i11)] = ((int)(f1 * 255.0F) << 16 | (int)(f2 * 255.0F) << 8 | (int)(f3 * 255.0F) << 0 | (int)(f4 * 255.0F) << 24);
/*     */ 
/* 257 */         f13 += f6;
/* 258 */         f14 += f8;
/*     */       }
...
/*     */     }
/*     */ 
/* 267 */     paramArrayOfImageData[1].releaseTransformedImage(localHeapImage1);
/* 268 */     paramArrayOfImageData[0].releaseTransformedImage(localHeapImage2);
/*     */ 
/* 271 */     return new ImageData(getFilterContext(), localHeapImage3, localRectangle1);
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.scenario.effect.impl.sw.java.JSWBlend_DIFFERENCEPeer
