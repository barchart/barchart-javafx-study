...
/*     */ {
/*     */   public JSWBlend_MULTIPLYPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/* 210 */         float f39 = f27;
/*     */ 
/* 212 */         float f28 = f32 * (f36 + 1.0F - f39) + f36 * (1.0F - f35);
/* 213 */         float f29 = f33 * (f37 + 1.0F - f39) + f37 * (1.0F - f35);
/* 214 */         float f30 = f34 * (f38 + 1.0F - f39) + f38 * (1.0F - f35);
/* 215 */         float f31 = f35 * (f39 + 1.0F - f39) + f39 * (1.0F - f35);
/*     */ 
/* 219 */         float f1 = f28;
/* 220 */         float f2 = f29;
/* 221 */         float f3 = f30;
 ...
 * Qualified Name:     com.sun.scenario.effect.impl.sw.java.JSWBlend_MULTIPLYPeer
