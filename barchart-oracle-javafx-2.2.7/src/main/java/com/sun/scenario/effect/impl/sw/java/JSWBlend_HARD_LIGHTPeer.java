...
/*     */ {
/*     */   public JSWBlend_HARD_LIGHTPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/* 217 */         float f44 = 0.5F * f39;
/*     */         float f40;
/* 218 */         if (f36 > f44) {
/* 219 */           f40 = f36 + f35 * (f36 - f39) - f32 * (2.0F * f36 - f39 - 1.0F);
/*     */         }
/*     */         else
/* 222 */           f40 = 2.0F * f32 * f36 + f32 * (1.0F - f39) + f36 * (1.0F - f35);
/*     */         float f41;
/* 224 */         if (f37 > f44) {
/* 225 */           f41 = f37 + f35 * (f37 - f39) - f33 * (2.0F * f37 - f39 - 1.0F);
/*     */         }
/*     */         else
/* 228 */           f41 = 2.0F * f33 * f37 + f33 * (1.0F - f39) + f37 * (1.0F - f35);
/*     */         float f42;
/* 230 */         if (f38 > f44) {
/* 231 */           f42 = f38 + f35 * (f38 - f39) - f34 * (2.0F * f38 - f39 - 1.0F);
/*     */         }
/*     */         else {
/* 234 */           f42 = 2.0F * f34 * f38 + f34 * (1.0F - f39) + f38 * (1.0F - f35);
/*     */         }
/* 236 */         float f28 = f40;
/* 237 */         float f29 = f41;
/* 238 */         float f30 = f42;
...
/* 246 */         float f4 = f31;
/*     */ 
/* 250 */         if (f4 < 0.0F) f4 = 0.0F; else if (f4 > 1.0F) f4 = 1.0F;
/* 251 */         if (f1 < 0.0F) f1 = 0.0F; else if (f1 > f4) f1 = f4;
/* 252 */         if (f2 < 0.0F) f2 = 0.0F; else if (f2 > f4) f2 = f4;
/* 253 */         if (f3 < 0.0F) f3 = 0.0F; else if (f3 > f4) f3 = f4;
/* 254 */         arrayOfInt3[(i9 + i11)] = ((int)(f1 * 255.0F) << 16 | (int)(f2 * 255.0F) << 8 | (int)(f3 * 255.0F) << 0 | (int)(f4 * 255.0F) << 24);
/*     */ 
/* 260 */         f13 += f6;
/* 261 */         f14 += f8;
/*     */       }
...
/*     */     }
/*     */ 
/* 270 */     paramArrayOfImageData[1].releaseTransformedImage(localHeapImage1);
/* 271 */     paramArrayOfImageData[0].releaseTransformedImage(localHeapImage2);
/*     */ 
/* 274 */     return new ImageData(getFilterContext(), localHeapImage3, localRectangle1);
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.scenario.effect.impl.sw.java.JSWBlend_HARD_LIGHTPeer
