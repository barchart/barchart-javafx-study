...
/*     */ {
/*     */   public JSWBlend_ADDPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/* 210 */         float f39 = f27;
/*     */ 
/* 214 */         float f44 = f32 * f39 + f36 * f35 - f39 * f35;
/* 215 */         float f45 = f33 * f39 + f37 * f35 - f39 * f35;
/* 216 */         float f46 = f34 * f39 + f38 * f35 - f39 * f35;
/* 217 */         float f47 = f35 * f39 + f39 * f35 - f39 * f35;
/* 218 */         float f48 = 0.0F;
/* 219 */         float f40 = f44 > f48 ? f44 : f48;
/* 220 */         float f41 = f45 > f48 ? f45 : f48;
/* 221 */         float f42 = f46 > f48 ? f46 : f48;
/* 222 */         float f43 = f47 > f48 ? f47 : f48;
/*     */ 
/* 225 */         f44 = f40;
/* 226 */         f45 = f41;
/* 227 */         f46 = f42;
/* 228 */         f47 = f43;
/* 229 */         float f28 = f32 + f36 - f44;
/* 230 */         float f29 = f33 + f37 - f45;
/* 231 */         float f30 = f34 + f38 - f46;
/* 232 */         float f31 = f35 + f39 - f47;
/*     */ 
/* 236 */         float f1 = f28;
/* 237 */         float f2 = f29;
/* 238 */         float f3 = f30;
/* 239 */         float f4 = f31;
/*     */ 
/* 243 */         if (f4 < 0.0F) f4 = 0.0F; else if (f4 > 1.0F) f4 = 1.0F;
/* 244 */         if (f1 < 0.0F) f1 = 0.0F; else if (f1 > f4) f1 = f4;
/* 245 */         if (f2 < 0.0F) f2 = 0.0F; else if (f2 > f4) f2 = f4;
/* 246 */         if (f3 < 0.0F) f3 = 0.0F; else if (f3 > f4) f3 = f4;
/* 247 */         arrayOfInt3[(i9 + i11)] = ((int)(f1 * 255.0F) << 16 | (int)(f2 * 255.0F) << 8 | (int)(f3 * 255.0F) << 0 | (int)(f4 * 255.0F) << 24);
/*     */ 
/* 253 */         f13 += f6;
/* 254 */         f14 += f8;
/*     */       }
...
/*     */     }
/*     */ 
/* 263 */     paramArrayOfImageData[1].releaseTransformedImage(localHeapImage1);
/* 264 */     paramArrayOfImageData[0].releaseTransformedImage(localHeapImage2);
/*     */ 
/* 267 */     return new ImageData(getFilterContext(), localHeapImage3, localRectangle1);
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.scenario.effect.impl.sw.java.JSWBlend_ADDPeer
