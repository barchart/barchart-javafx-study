...
/*     */ 
/*     */   public PPSPhongLighting_POINTPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/* 150 */     localHashMap2.put("diffuseConstant", Integer.valueOf(0));
/* 151 */     localHashMap2.put("surfaceScale", Integer.valueOf(12));
/* 152 */     localHashMap2.put("lightColor", Integer.valueOf(3));
/* 153 */     localHashMap2.put("kvals", Integer.valueOf(4));
/* 154 */     localHashMap2.put("lightPosition", Integer.valueOf(13));
/* 155 */     localHashMap2.put("specularConstant", Integer.valueOf(1));
/* 156 */     localHashMap2.put("specularExponent", Integer.valueOf(2));
/*     */ 
/* 158 */     return getRenderer().createShader(getShaderName(), localHashMap1, localHashMap2, true);
/*     */   }
/*     */ 
/*     */   protected void updateShader(Shader paramShader)
/*     */   {
/* 164 */     paramShader.setConstant("diffuseConstant", getDiffuseConstant());
/* 165 */     paramShader.setConstant("surfaceScale", getSurfaceScale());
/* 166 */     float[] arrayOfFloat1 = getLightColor();
/* 167 */     paramShader.setConstant("lightColor", arrayOfFloat1[0], arrayOfFloat1[1], arrayOfFloat1[2]);
/* 168 */     paramShader.setConstants("kvals", getKvals(), 0, getKvalsArrayLength());
/* 169 */     float[] arrayOfFloat2 = getLightPosition();
/* 170 */     paramShader.setConstant("lightPosition", arrayOfFloat2[0], arrayOfFloat2[1], arrayOfFloat2[2]);
/* 171 */     paramShader.setConstant("specularConstant", getSpecularConstant());
/* 172 */     paramShader.setConstant("specularExponent", getSpecularExponent());
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.scenario.effect.impl.prism.ps.PPSPhongLighting_POINTPeer
