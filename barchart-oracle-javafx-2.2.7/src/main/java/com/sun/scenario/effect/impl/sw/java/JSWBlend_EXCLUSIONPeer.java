...
/*     */ {
/*     */   public JSWBlend_EXCLUSIONPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/* 217 */         float f40 = f36 + f32 - 2.0F * f36 * f32;
/* 218 */         float f41 = f37 + f33 - 2.0F * f37 * f33;
/* 219 */         float f42 = f38 + f34 - 2.0F * f38 * f34;
/* 220 */         float f28 = f40;
/* 221 */         float f29 = f41;
/* 222 */         float f30 = f42;
/* 223 */         float f31 = f43;
...
/* 230 */         float f4 = f31;
/*     */ 
/* 234 */         if (f4 < 0.0F) f4 = 0.0F; else if (f4 > 1.0F) f4 = 1.0F;
/* 235 */         if (f1 < 0.0F) f1 = 0.0F; else if (f1 > f4) f1 = f4;
/* 236 */         if (f2 < 0.0F) f2 = 0.0F; else if (f2 > f4) f2 = f4;
/* 237 */         if (f3 < 0.0F) f3 = 0.0F; else if (f3 > f4) f3 = f4;
/* 238 */         arrayOfInt3[(i9 + i11)] = ((int)(f1 * 255.0F) << 16 | (int)(f2 * 255.0F) << 8 | (int)(f3 * 255.0F) << 0 | (int)(f4 * 255.0F) << 24);
/*     */ 
/* 244 */         f13 += f6;
/* 245 */         f14 += f8;
/*     */       }
...
/*     */     }
/*     */ 
/* 254 */     paramArrayOfImageData[1].releaseTransformedImage(localHeapImage1);
/* 255 */     paramArrayOfImageData[0].releaseTransformedImage(localHeapImage2);
/*     */ 
/* 258 */     return new ImageData(getFilterContext(), localHeapImage3, localRectangle1);
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.scenario.effect.impl.sw.java.JSWBlend_EXCLUSIONPeer
