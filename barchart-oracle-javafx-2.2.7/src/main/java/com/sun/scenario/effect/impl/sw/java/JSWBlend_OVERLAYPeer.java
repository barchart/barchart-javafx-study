...
/*     */ {
/*     */   public JSWBlend_OVERLAYPeer(FilterContext paramFilterContext, Renderer paramRenderer, String paramString)
/*     */   {
...
/*     */ 
/* 219 */         float f47 = f32 - f35 * 0.5F;
/* 220 */         float f48 = f33 - f35 * 0.5F;
/* 221 */         float f49 = f34 - f35 * 0.5F;
/* 222 */         float f44 = (float)Math.ceil(f47);
/* 223 */         float f45 = (float)Math.ceil(f48);
/* 224 */         float f46 = (float)Math.ceil(f49);
/*     */ 
/* 227 */         f47 = f44;
/* 228 */         f48 = f45;
/* 229 */         f49 = f46;
/*     */ 
/* 232 */         float f53 = f32 - f47 * f35;
/* 233 */         float f54 = f33 - f48 * f35;
/* 234 */         float f55 = f34 - f49 * f35;
/* 235 */         float f50 = Math.abs(f53);
/* 236 */         float f51 = Math.abs(f54);
/* 237 */         float f52 = Math.abs(f55);
/*     */ 
/* 240 */         f53 = f50;
/* 241 */         f54 = f51;
/* 242 */         f55 = f52;
/*     */ 
/* 244 */         float f56 = f36 - f47 * f39;
/* 245 */         float f57 = f37 - f48 * f39;
/* 246 */         float f58 = f38 - f49 * f39;
/* 247 */         f50 = Math.abs(f56);
/* 248 */         f51 = Math.abs(f57);
/* 249 */         f52 = Math.abs(f58);
/*     */ 
/* 252 */         f56 = f50;
/* 253 */         f57 = f51;
/* 254 */         f58 = f52;
/* 255 */         float f40 = (2.0F * f53 + 1.0F - f35) * f56 + (1.0F - f39) * f53;
/* 256 */         float f41 = (2.0F * f54 + 1.0F - f35) * f57 + (1.0F - f39) * f54;
/* 257 */         float f42 = (2.0F * f55 + 1.0F - f35) * f58 + (1.0F - f39) * f55;
/*     */ 
/* 259 */         float f59 = f40 - f47 * f43;
/* 260 */         float f60 = f41 - f48 * f43;
/* 261 */         float f61 = f42 - f49 * f43;
/* 262 */         f50 = Math.abs(f59);
/* 263 */         f51 = Math.abs(f60);
/* 264 */         f52 = Math.abs(f61);
/*     */ 
/* 267 */         f40 = f50;
/* 268 */         f41 = f51;
/* 269 */         f42 = f52;
...
/* 280 */         float f4 = f31;
/*     */ 
/* 284 */         if (f4 < 0.0F) f4 = 0.0F; else if (f4 > 1.0F) f4 = 1.0F;
/* 285 */         if (f1 < 0.0F) f1 = 0.0F; else if (f1 > f4) f1 = f4;
/* 286 */         if (f2 < 0.0F) f2 = 0.0F; else if (f2 > f4) f2 = f4;
/* 287 */         if (f3 < 0.0F) f3 = 0.0F; else if (f3 > f4) f3 = f4;
/* 288 */         arrayOfInt3[(i9 + i11)] = ((int)(f1 * 255.0F) << 16 | (int)(f2 * 255.0F) << 8 | (int)(f3 * 255.0F) << 0 | (int)(f4 * 255.0F) << 24);
/*     */ 
/* 294 */         f13 += f6;
/* 295 */         f14 += f8;
/*     */       }
...
/*     */     }
/*     */ 
/* 304 */     paramArrayOfImageData[1].releaseTransformedImage(localHeapImage1);
/* 305 */     paramArrayOfImageData[0].releaseTransformedImage(localHeapImage2);
/*     */ 
/* 308 */     return new ImageData(getFilterContext(), localHeapImage3, localRectangle1);
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jfxrt/jfxrt.jar
 * Qualified Name:     com.sun.scenario.effect.impl.sw.java.JSWBlend_OVERLAYPeer
