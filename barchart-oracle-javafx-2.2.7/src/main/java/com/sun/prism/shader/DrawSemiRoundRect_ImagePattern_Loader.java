...
/* 48 */     localHashMap2.put("idim", Integer.valueOf(1));
/* 49 */     localHashMap2.put("oinvarcradii", Integer.valueOf(0));
/* 50 */     localHashMap2.put("xParams", Integer.valueOf(2));
/* 51 */     localHashMap2.put("yParams", Integer.valueOf(3));
/* 52 */     localHashMap2.put("perspVec", Integer.valueOf(4));
/*    */ 
 ...
 * Qualified Name:     com.sun.prism.shader.DrawSemiRoundRect_ImagePattern_Loader
